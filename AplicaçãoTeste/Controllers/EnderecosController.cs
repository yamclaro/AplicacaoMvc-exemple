...
namespace AplicaçãoTeste.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Endereco.Include(e => e.Fornecedor);
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,Logradouro,Numero,Complemento,Cep,Bairro,Cidade,Estado,Id")] Endereco endereco)
        {
            ...
            ViewData["FornecedorId"] = new SelectList(_context.Set<Fornecedor>(), "Id", "Id", endereco.FornecedorId);
            return View(endereco);
        }
